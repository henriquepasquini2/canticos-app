  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-text-secondary mt-1">Cronograma de domingos</p>
      </div>
      ...
      {/* Grid calendar - hidden on mobile */}
        ...
        <div className="grid grid-cols-7 gap-px rounded-b-xl overflow-hidden border border-border">
          ...
          {daysInMonth.map((day) => {
            ...
            const cellProps = isSunday(day)
              ? { to: `/domingo/${dateStr}`, key: dateStr }
              : { key: dateStr }
            ...
            return (
              <CellTag
                {...cellProps as any}
                className={cn(
                  'p-2 transition-colors block min-h-24',
